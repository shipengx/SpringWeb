<html>
<head>
<title>Shipeng's Java website</title>
<style>
body {
...
<body>
	...
	<div class="main">
		...
		<p>A paragraph is a series of sentences that are organized and
			...
			reader see the organization of the essay and grasp its main points.</p>
		<p>Sunset is the time of day when our sky meets the outer space
			solar winds. There are blue, pink, and purple swirls, spinning and
			twisting, like clouds of balloons caught in a blender. The sun moves
			slowly to hide behind the line of horizon, while the moon races to
